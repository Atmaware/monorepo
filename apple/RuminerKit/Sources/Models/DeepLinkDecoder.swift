...
public extension DeepLink {
  ...
  static func make(from url: URL) -> DeepLink? {
    if url.scheme == "ruminer" {
      return deepLinkFromRuminerScheme(url: url)
    }

    return nil
  }

  private static func deepLinkFromRuminerScheme(url: URL) -> DeepLink? {
    switch url.host {
    case "search":
...
// Example deep links
// "ruminer://shareExtensionRequestID/sampleRequestID"
