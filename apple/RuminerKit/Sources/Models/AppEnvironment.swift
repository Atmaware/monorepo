...
private let devBaseURL = "https://api-dev.ruminer.app"
private let demoBaseURL = "https://api-demo.ruminer.app"
private let prodBaseURL = "https://api-prod.ruminer.app"

private let demoTtsURL = "https://tts-demo.ruminer.app"
private let prodTtsURL = "https://tts-prod.ruminer.app"

private let devWebURL = "https://web-dev.ruminer.app"
private let demoWebURL = "https://demo.ruminer.app"
private let prodWebURL = "https://ruminer.app"
...
public extension AppEnvironment {
  static func setCustom(serverBaseURL: String, webAppBaseURL: String, ttsBaseURL: String) {
    guard let sharedDefaults = UserDefaults(suiteName: "group.app.ruminerapp") else {
  ...
  var environmentConfigured: Bool {
    if self == .custom {
      guard
        let sharedDefaults = UserDefaults(suiteName: "group.app.ruminerapp"),
