...
public enum WebViewManager {
  ...
  public static func shared() -> RuminerWebView {
    sharedView
  }

  public static func create() -> RuminerWebView {
    RuminerWebView(frame: CGRect.zero, configuration: WebViewConfigurationManager.create())
  }
}
