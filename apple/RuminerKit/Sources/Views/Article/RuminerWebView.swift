...
public final class RuminerWebView: WKWebView {
  #if os(iOS)
...
#if os(iOS)
  extension RuminerWebView: UIGestureRecognizerDelegate, WKScriptMessageHandler {
    ...
    override public func buildMenu(with builder: UIMenuBuilder) {
      if #available(iOS 16.0, *) {
        ...
        let ruminer = UIMenu(title: "", options: .displayInline, children: items)
        builder.insertSibling(ruminer, afterMenu: .standardEdit)
      }
