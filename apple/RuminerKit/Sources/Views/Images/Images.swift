...
public extension Image {
  static var smallRuminerLogo: Image { Image("_smallRuminerLogo", bundle: .module) }
  static var coloredSmallRuminerLogo: Image { Image("app-icon", bundle: .module) }
  static var ruminerTitleLogo: Image { Image("_ruminerTitleLogo", bundle: .module) }
