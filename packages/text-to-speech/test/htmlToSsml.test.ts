...
describe('stripEmojis', () => {
  ...
  it('strips emojis from html and removes the extra space', () => {
    const text = `<h2 data-ruminer-anchor-idx="37">🧠Brain food</h2>`

    expect(stripEmojis(text)).to.equal(
      `<h2 data-ruminer-anchor-idx="37">Brain food</h2>`
    )
  })
})
...
`
  ...
  it('splits sentences in German correctly', () => {
    const html = `<div class="page" id="readability-page-1" data-ruminer-anchor-idx="1">
<p data-ruminer-anchor-idx="2"><span data-ruminer-anchor-idx="3"><span data-ruminer-anchor-idx="4"><strong data-ruminer-anchor-idx="5"><em data-ruminer-anchor-idx="6"><span data-ruminer-anchor-idx="7" lang="DE" xml:lang="DE"><span data-ruminer-anchor-idx="8">Q</span></span></em></strong><em data-ruminer-anchor-idx="9"><span data-ruminer-anchor-idx="10" lang="DE" xml:lang="DE"><span data-ruminer-anchor-idx="11"><strong data-ruminer-anchor-idx="12">:</strong> „Die kürzliche Razzia in den BBC-Büros in Delhi sind ein weiterer Versuch der Regierung, kritische Medien-Kommentare zu unterdrücken. Man hat des Gefühl, Herr Modi hat Angst, in den Spiegel zu schauen!?“</span></span></em></span></span></p>
</div>`
    const speechFile = htmlToSpeechFile({
      content: html,
      options: TEST_OPTIONS,
  ...
  it('splits sentences in Chinese correctly', () => {
    const html = `<div class="page" id="readability-page-1" data-ruminer-anchor-idx="1">
  <p data-ruminer-anchor-idx="2">这是一段中文，我想看看它是怎么分句的。如果买二手房有中介参与，要找相对大的、知名的中介。中介的收费、服务情况要先问清。还要和中介谈好，中介费的付款时间，一般来说是签完合同付一部分，过户后付一部分，省的太早付完钱，中介就不管事了。付完记得要发票。中介如果提供贷款服务，让他玩去。贷款之类的问题，别怕麻烦，自己去找银行。</p>
</div>`
    const speechFile = htmlToSpeechFile({
      content: html,
      options: TEST_OPTIONS,
  ...
  it('parses the smart quotes correctly', () => {
    const html = `
    <div class="page" id="readability-page-1" data-ruminer-anchor-idx="1">
      <p data-ruminer-anchor-idx="23">Nor was Stalin any kind of naïve, unsuspecting victim of Hitler’s <a data-ruminer-anchor-idx="24" href="https://archive.ph/o/AGEPn/https://www.britannica.com/event/Operation-Barbarossa" rel="noopener noreferrer" target="_blank" title="">Barbarossa onslaught</a>, as some historical clichés would have it. McMeekin makes an extended case that Stalin was preparing to attack Nazi Germany when Hitler attacked him, that the two dictators were basically in a race to see who could mobilize to betray the other first — and that the initial Soviet debacle in 1941 happened in part because Stalin was also pushing his military toward an offensive alignment, and they were caught in a “mid-mobilization limbo.”</p>
    </div>
    `
  ...
  it('skip unwanted elements', () => {
    const html = `<div class="page" id="readability-page-1" data-ruminer-anchor-idx="1">
      <p data-ruminer-anchor-idx="2">This is a test.</p>
      <script data-ruminer-anchor-idx="3">alert('hello');</script>
      <style data-ruminer-anchor-idx="4">body { color: red; }</style>
      <iframe data-ruminer-anchor-idx="6" src="https://example.com">test</iframe>
      <figcaption data-ruminer-anchor-idx="7">test</figcaption>
      </div>`
  ...
  it('filters out utterances with only punctuation or whitespace', () => {
    const html = `<div class="page" id="readability-page-1" data-ruminer-anchor-idx="1">
      <p data-ruminer-anchor-idx="2">This is a test.</p>
      <p data-ruminer-anchor-idx="3">.</p>
      <p data-ruminer-anchor-idx="4"> </p>
      </div>`
