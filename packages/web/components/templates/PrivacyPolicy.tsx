...
export function PrivacyPolicy(props: PrivacyPolicyProps): JSX.Element {
  return (
    ...
    >
      <div>
        <StyledText style="boldHeadline">Privacy Policy</StyledText>
      ...
      <StyledText style="headline">Interpretation and Definitions</StyledText>
      <StyledText style="subHeadline">Interpretation</StyledText>
      <StyledText style="body">
      ...
      <StyledText style="subHeadline">Definitions</StyledText>
      <StyledText style="body">
        For the purposes of this Privacy Policy:
      </StyledText>
      <StyledText style="body" css={{ padding: '8px 30px' }}>
        <StyledText style="body">
        ...
        <StyledText style="body">
          ...
          or create an account to use the Service. Usage Data refers to data
      ...
      <StyledText style="headline">
        Collecting and Using Your Personal Data
      </StyledText>
      <StyledText style="subHeadline">Types of Data Collected</StyledText>
      <StyledText style="bodyBold">Personal Data</StyledText>
      <StyledText style="body">
      ...
      <StyledText style="bodyBold">Usage Data</StyledText>
      <StyledText style="body">
      ...
      <StyledList>
        <StyledListElement> Google </StyledListElement>
      ...
      <StyledText style="body">
        ...
        close Your web browser. Learn more about cookies: What Are Cookies?. We
      ...
      <StyledText style="subHeadline">Use of Your Personal Data</StyledText>
      <StyledText style="body">
      ...
      <StyledText style="body" css={{ padding: '8px 30px' }}>
        ...
        <StyledText style="body">
          ...
          requests to Us. For business transfers: We may use Your information to
      ...
      <StyledList>
        ...
        <StyledListElement>
          ...
          outside. If You interact with other users or register through a Third-
          Party Social Media Service, Your contacts on the Third-Party Social
          Media Service may see Your name, profile, pictures and description of
      ...
      <StyledText style="bodyBold">Business Transactions</StyledText>
      <StyledText style="body">
      ...
      <StyledText style="bodyBold">Law enforcement</StyledText>
      <StyledText style="body">
        Under certain circumstances, the Company may be required to disclose
        Your Personal Data if required to do so by law or in response to valid
        requests by public authorities (e.g. a court or a government agency).
      </StyledText>
      <StyledText style="bodyBold">Other legal requirements</StyledText>
      <StyledText style="body">
        The Company may disclose Your Personal Data in the good faith belief
        that such action is necessary to:
      </StyledText>
      <StyledList>
        <StyledListElement> Comply with a legal obligation</StyledListElement>
        <StyledListElement>
          {' '}
        ...
        <StyledListElement> Protect against legal liability</StyledListElement>
      </StyledList>
      <StyledText style="subHeadline">
      ...
      <StyledText style="headline">GDPR Privacy</StyledText>
      <StyledText style="subHeadline">
      ...
      <StyledText style="subHeadline">Your Rights under the GDPR</StyledText>
      <StyledText style="body">
      ...
      <StyledText style="headline">CCPA Privacy</StyledText>
      <StyledText style="body">
      ...
      <StyledText style="body" css={{ padding: '8px 30px' }}>
        ...
        <StyledText style="body">Collected: Yes.</StyledText>
        <StyledText style="body">
          <strong>
        ...
        <StyledText style="body">Collected: No.</StyledText>
        <StyledText style="body">
      ...
      <StyledText style="body" css={{ padding: '8px 30px' }}>
        <StyledText style="body">Category A: Identifiers</StyledText>
        <StyledText style="body">
          Category B: Personal information categories listed in the California
          Customer Records statute (Cal. Civ. Code § 1798.80(e))
        </StyledText>
        <StyledText style="body"></StyledText>
        <StyledText style="body">
          Category F: Internet or other similar network activity
        </StyledText>
      </StyledText>
      ...
      <StyledText style="subHeadline">Sale of Personal Information</StyledText>
      <StyledText style="body">
      ...
      <StyledText style="subHeadline">Share of Personal Information</StyledText>
      <StyledText style="body">
        We may share Your personal information identified in the above
        categories with the following categories of third parties:
      </StyledText>
      <StyledText style="body" css={{ padding: '8px 30px' }}>
        <StyledText style="body">Service Providers</StyledText>
        <StyledText style="body">Our affiliates</StyledText>
        <StyledText style="body">Our business partners</StyledText>
        <StyledText style="body">
      ...
      <StyledText style="subHeadline">Your Rights under the CCPA</StyledText>
      <StyledText style="body">
      ...
      <StyledText style="body">Your request to Us must:</StyledText>
      <StyledList>
        <StyledListElement>
      ...
      <StyledText style="headline">Children&apos;s Privacy</StyledText>
      <StyledText style="body">
      ...
      <StyledText style="headline">Links to Other Websites</StyledText>
      <StyledText style="body">
      ...
      <StyledText style="headline">Changes to this Privacy Policy</StyledText>
      <StyledText style="body">
      ...
      <StyledText style="headline">Contact Us</StyledText>
      <StyledText style="body">
