  ...
  return (
    <ProfileLayout logoDestination="/home">
      ...
      >
        ...
        >
          Ruminer supports uploading the Archive.zip file generated by
        ...
        <StyledText
          ...
          css={{ color: theme.colors.ruminerGray.toString() }}
        >
          <a href="https://docs.ruminer.app/using/importing.html#importing-data-from-matter">
            More info
          </a>
        </StyledText>
        <StyledText
          style="caption"
          css={{ pt: '20px', color: theme.colors.ruminerGray.toString() }}
        >
