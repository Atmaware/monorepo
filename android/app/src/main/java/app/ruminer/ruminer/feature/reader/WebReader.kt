                    ...
                    if (event.action == KeyEvent.ACTION_DOWN) {
                        when (keyCode) {
                            KeyEvent.KEYCODE_VOLUME_UP -> {
                                ...
                                scrollVertically(RuminerWebView.Direction.UP)
                            ...
                            KeyEvent.KEYCODE_VOLUME_DOWN -> {
                                ...
                                scrollVertically(RuminerWebView.Direction.DOWN)
                                return@setOnKeyListener true
                            }
                        }
                    }
...
class RuminerWebView(context: Context) : WebView(context), OnScrollChangeListener {
