...
data class WebReaderContent(
    ...
    fun styledContent(): String {
        ...
        val rtlCss = if (rtlText) {
            """
            body, html, #_ruminer-htmlContent, p, a, div, span {
                direction: rtl;
                text-align: right;
            }
            """
            ...
            <body>
              ...
              <script type="text/javascript">
                ...
                window.ruminerArticle = {
                  ...
                  content: document.getElementById('_ruminer-htmlContent').innerHTML,
